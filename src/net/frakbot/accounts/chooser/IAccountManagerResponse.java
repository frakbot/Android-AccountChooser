...
/**
 * The interface used to return responses for asynchronous calls to the
 * {@link IAccountManager}
 * 
 * @hide
 */
public interface IAccountManagerResponse extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		 ...
		 * android.accounts.IAccountManagerResponse interface, generating a
		 * proxy if needed.
		 */
		public static IAccountManagerResponse asInterface(android.os.IBinder obj) {
			if ((obj == null)) {
				return null;
			}
			...
			return new IAccountManagerResponse.Stub.Proxy(obj);
		}
